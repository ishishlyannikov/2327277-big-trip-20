...
function createEditEventTemplate(tripPoint,offers,destination) {
  const {dateFrom, dateTo, type, basePrice} = tripPoint;

  const beginTrip = humanizeDate(dateFrom, DATE_FORMAT);
  const endTrip = humanizeDate(dateTo, DATE_FORMAT);
  ...
  return (
    ...
    <header class="event__header">
      <div class="event__type-wrapper">
        ...
        <div class="event__type-list">
          <fieldset class="event__type-group">
            ...
            ${createEventTypeTemplate(WAYPOINT_TYPES)}
      ...
      <div class="event__field-group  event__field-group--time">
        ...
        <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${beginTrip}">
        &mdash;
        <label class="visually-hidden" for="event-end-time-1">To</label>
        <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${endTrip}">
      </div>
...
export default class EditEventView {
  constructor({destination, tripPoint = DEFAULT_POINT, offers}) {
